...
class Cer6_24(mb.Compound):
    def __init__(self):
        """Returns a CG uCER6 with the head-to-tail vector pointing in -z.
        """
        super(Cer6_24, self).__init__()
        mb.load('cer6-24.hoomdxml', compound=self, relative_to_module=self.__module__)
        ...
        self.masses = [0.403639, 0.584458, 0.584458, 0.584458, 0.584458, 0.584458,
                  0.584458, 0.556458, 0.597575, 0.556458, 0.556458, 0.584458,
