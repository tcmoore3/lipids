...
class Cer6_16(mb.Compound):
    def __init__(self):
        """Returns a CG eCER6 with the head-to-tail vector pointing in -z.
        """
        super(Cer6_16, self).__init__()
        mb.load('cer6-16.hoomdxml', compound=self, relative_to_module=self.__module__)
        ...
        self.masses = [0.598458, 0.584458, 0.584458,
